...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'LR_ARMs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kogaku/hogehoge_ws/install/${idir}'.  Ask the maintainer 'kogaku <kogaku@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/kogaku/hogehoge_ws/install/lib;/home/kogaku/ros_ws/devel/lib;/opt/ros/indigo/lib)
